...
failingTests =
  ...
  , "common/hs/thrift/exactprint/tests/fbthrift-tests/python_capi/src/thrift_dep.thrift"
  , "common/hs/thrift/exactprint/tests/fbthrift-tests/py3/src/module.thrift"
  ...
  , "common/hs/thrift/exactprint/tests/fbthrift-tests/rust-annotations/src/module.thrift"
  ...
  , "common/hs/thrift/exactprint/tests/fbthrift-tests/sync-methods-return-try/src/module.thrift"
