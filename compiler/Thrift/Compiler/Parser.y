...
Struct
  : StructType Symbol '{' list(Field) '}' Annotations
    { Struct
      { structName         = lVal $2
      , structResolvedName = ()
      , structType         = lVal $1
      ...
      , structLoc          = StructLoc
        { slKeyword    = lLoc $1
        , slName       = lLoc $2
        , slOpenBrace  = getLoc $3
        , slCloseBrace = getLoc $5
        }
      , structAnns         = $6
      }
    }
...
Field : intLit ':' Req AnnotatedType Symbol MaybeConst Annotations Separator
        { case $4 of
            This t -> Field
              { fieldId           = fromIntegral $ lParsed $1
              , fieldName         = lVal $5
              , fieldResolvedName = ()
              , fieldType         = t
              , fieldResolvedType = ()
...
Union :: { Parsed Union }
Union
  : union Symbol '{' list(UnionAlt) '}' Annotations
    { Union
      { unionName         = lVal $2
      , unionResolvedName = ()
      , unionAlts         = $4
...
UnionAlt
  : intLit ':' AnnotatedType Symbol MaybeConst Annotations Separator
    { case $3 of
        This t -> UnionAlt
          { altId           = fromIntegral $ lParsed $1
          , altName         = lVal $4
          , altResolvedName = ()
          , altType         = t
          , altResolvedType = ()
...
Typedef : typedef AnnotatedType Symbol Annotations
          { case $2 of
              This t -> Typedef
                { tdName         = lVal $3
                , tdResolvedName = ()
...
Const :: { Parsed Const }
Const : const AnnotatedType Symbol '=' UntypedConst Separator
        { case $2 of
            This ty -> Const
              { constName         = lVal $3
              , constResolvedName = ()
...
UntypedConst
  : intLit     { UntypedConst (lLoc $1) (uncurry IntVal $ lVal $1) }
  | doubleLit  { UntypedConst (lLoc $1) (uncurry DoubleVal $ lVal $1) }
  | stringLit  { UntypedConst (lLoc $1) (uncurry StringVal $ lVal $1) }
  | true       { UntypedConst (getLoc $1) (BoolVal True) }
  | false      { UntypedConst (getLoc $1) (BoolVal False) }
  | Symbol     { UntypedConst (lLoc $1) (IdVal $ lVal $1) }
  | '[' list(ListElem) ']'
    { UntypedConst
      { ucLoc   = getLoc $1
      , ucConst = ListVal
...
Enum :: { Parsed Enum }
Enum : enum Symbol '{' list(EnumVal) '}' Annotations
       { Enum
         { enumName         = lVal $2
         , enumResolvedName = ()
         , enumIsPseudo     = ()
...
EnumVal : Symbol '=' intLit Annotations Separator
          { EnumValue
            { evName         = lVal $1
            , evResolvedName = ()
            , evValue        = fromIntegral $ lParsed $3
            , evLoc          = EnumValLoc
              { evlName      = lLoc $1
              , evlEqual     = getLoc $2
              , evlValue     = lLoc $3
...
Service
  : service Symbol Extends '{' list(Function) '}' Annotations
     { Service
       { serviceName         = lVal $2
       , serviceResolvedName = ()
       , serviceSuper        = $3
...
Function :: { Parsed Function }
  : IsOneway FunType Symbol '(' list(Argument) ')' Throws Annotations Separator
    { Function
      { funName         = lVal $3
      , funResolvedName = ()
      , funType         = $2
      , funResolvedType = ()
      , funArgs         = $5
      , funExceptions   = maybe [] snd $7
      , funIsOneWay     = isJust $1
      , funPriority     = NormalPriority
      , funLoc          = FunLoc
        { fnlOneway     = $1
        , fnlName       = lLoc $3
        , fnlOpenParen  = getLoc $4
        , fnlCloseParen = getLoc $6
        , fnlThrows     = fmap fst $7
        , fnlSeparator  = $9
        }
      , funAnns         = $8
      }
...
Argument : intLit ':' AnnotatedType Symbol MaybeConst Annotations Separator
  { case $3 of
     This t -> Field
       { fieldId           = fromIntegral $ lParsed $1
       , fieldName         = lVal $4
...
Throw : intLit ':' AnnotatedType Symbol MaybeConst Annotations Separator
        { case $3 of
            This t -> Field
              { fieldId           = fromIntegral $ lParsed $1
              , fieldName         = lVal $4
