...
static_assert(
    std::is_standard_layout<DummyHsRange>::value,
    "DummyHsRange is a standard-layout class");
static_assert(
...
static_assert(
    std::is_standard_layout<DummyHsMaybe>::value,
    "DummyHsMaybe is a standard-layout class");
static_assert(
...
static_assert(
    std::is_standard_layout<DummyHsEither>::value,
    "DummyHsEither is a standard-layout class");
static_assert(
...
static_assert(
    std::is_standard_layout<DummyHsPair>::value,
    "DummyHsPair is a standard-layout class");
static_assert(
...
static_assert(
    std::is_standard_layout<HsString>::value,
    "HsString is a standard-layout class");
...
static_assert(
    std::is_standard_layout<DummyHsArray>::value,
    "DummyHsArray is a standard-layout class");
static_assert(
...
static_assert(
    std::is_standard_layout<DummyHsIntMap>::value,
    "DummyHsIntMap is a standard-layout class");

template <typename T>
using HsObject = HsMap<HsString, T>;
using DummyHsObject = HsObject<std::nullptr_t>;
static_assert(
    std::is_standard_layout<DummyHsObject>::value,
    "DummyHsObject is a standard-layout class");
...
static_assert(
    std::is_standard_layout<HsJSON>::value,
    "HsJSON is a standard-layout class");
